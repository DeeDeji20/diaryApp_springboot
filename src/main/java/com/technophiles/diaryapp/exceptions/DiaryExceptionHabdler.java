...
@ControllerAdvice
public class DiaryExceptionHabdler extends ResponseEntityExceptionHandler{
    ...
    public ResponseEntity<Object> diaryApplicationException(Exception exception, WebRequest request){
        ApiResponse apiResponse = ApiResponse.builder()
                .message(exception.getMessage())
                .isSuccessful(false)
                .statusCode(400)
